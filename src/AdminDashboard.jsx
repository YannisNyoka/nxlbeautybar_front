...
const SECTION_TITLES = { overview:'Dashboard Overview', appointments:'Appointments', services:'Services', staff:'Staff Management', clients:'Clients', availability:'Availability', payments:'Payments & Reports', notifications:'Activity Log', gallery:'Gallery Management' };
